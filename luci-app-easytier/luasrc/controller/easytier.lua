...
function get_upload_config()
	...
	local config = {
		...
		github_proxys = {},
		fallback_version = uci:get_first("easytier", "easytier", "fallback_version") or "v2.6.4.1"
	}
...
function save_upload_config()
	...
	uci:set("easytier", "@easytier[0]", "fallback_version", data.fallback_version or "v2.6.4.1")
